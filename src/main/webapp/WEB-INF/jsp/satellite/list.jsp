										...
										<tr>
											...
											<td>
												...
												<button class="btn btn-outline-danger btn-sm" type="button"
													...
													data-delete-url="${pageContext.request.contextPath}/satellite/delete/${satelliteItem.id }"
													data-delete-label="${satelliteItem.denominazione } ${satelliteItem.codice }">
													Delete
												</button>
											</td>
										</tr>
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-body">
						Vuoi davvero cancellare <strong id="deleteModalItemLabel">questo satellite</strong>?
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Annulla</button>
						<a class="btn btn-danger" id="confirmDeleteButton" href="#">Conferma</a>
					</div>
				</div>
			</div>
		</div>
		...
		<script>
			document.addEventListener('DOMContentLoaded', function() {
				...
				deleteModal.addEventListener('show.bs.modal', function(event) {
					...
					const deleteLabel = triggerButton.getAttribute('data-delete-label');
