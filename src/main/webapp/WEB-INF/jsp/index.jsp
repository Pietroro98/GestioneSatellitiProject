			  ...
			  <div class="container">
			     ...
			     <div class="p-5 mb-4 bg-light rounded-3">
				      <div class="container-fluid py-5">
				        ...
				        <p class="col-md-8 fs-4">I satelliti artificiali sono dispositivi complessi, oggi oltre 11.000 attivi,
							progettati per orbite specifiche (LEO, GEO) al fine di compiere missioni come osservazione terrestre,
							comunicazioni, navigazione (GPS) e ricerca scientifica. La loro gestione include progettazione, lancio,
							monitoraggio operativo, manovre di correzione orbitale e infine la deorbitazione a fine vita.</p>
			  ...
			  <div class="container px-4 py-5" id="featured-3">
			    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
			      ...
			      <div class="feature col">
			        ...
			        <p>Inizia la ricerca dei satelliti disponibili nel DB.</p>
			      ...
			      <div class="feature col">
			        ...
			        <p>Inserisci un nuovo satellite e inizia con la sua gestione.</p>
